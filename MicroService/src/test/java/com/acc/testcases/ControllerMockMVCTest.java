...
public class ControllerMockMVCTest extends AbstractControllerTestClass {
	...
	public void testAddUser() throws Exception {
		...
		InfoDTO dto = new InfoDTO(0, "abhi@test.com", "abhi", "Abhirup", "",
				"Debnath", "Male", "1994-11-11", "1234567890", "12345", 123456,
				"ASE", "ASE", "", 0, "abc", "xyz", 123123, "India",
				"Telangana", "RR", "Hyd", "Ch", 0, new Date(), "11:00",
				new Date(), "12:00", "107,108", "true", "true", "true", "true");
	...
	public void testUpdateUser() throws Exception {
		...
		InfoDTO dto = new InfoDTO(108, "abhi@test.com", "abhi", "Abhirup", "",
				"Debnath", "Male", "1994-11-11", "1234567891", "12345", 123456,
				"ASE", "ASE", "", 8, "abc", "xyz", 123123, "India",
				"Telangana", "RR", "Hyd", "Ch", 16, new Date(), "11:00",
				new Date(), "12:00", "107,108", "true", "true", "true", "true");
	...
	public void testAddMeeting() throws Exception {
		...
		InfoDTO dto = new InfoDTO(108, "abhi@test.com", "abhi", "Abhirup", "",
				"Debnath", "Male", "1994-11-11", "1234567890", "12345", 123456,
				"ASE", "ASE", "", 8, "abc", "xyz", 123123, "India",
				"Telangana", "RR", "Hyd", "Ch", 0, new Date(), "10:00",
				new Date(), "12:00", "106,107", "true", "true", "true", "true");
	...
	public void testUpdateMeeting() throws Exception {
		...
		InfoDTO dto = new InfoDTO(108, "abhi@test.com", "abhi", "Abhirup", "",
				...
				"ASE", "ASE", "", 8, "abc", "xyz", 123123, "India",
				"Telangana", "RR", "Hyd", "Ch", 16, new Date(), "11:00",
				new Date(), "14:00", "106,107", "true", "true", "true", "true");
